...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		...
		<div class="site-branding">
			...
			$anima_petj_description = get_bloginfo( 'description', 'display' );
			if ( $anima_petj_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $anima_petj_description; /* WPCS: xss ok. */ ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
